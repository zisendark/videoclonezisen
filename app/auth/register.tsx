    ...
    <SafeAreaView style={tw`flex-1 bg-white`}>
      ...
      >
        <View style={tw`px-6 w-full items-center`}>
          ...
          {/* Header */}
          <Text style={tw`text-2xl font-bold mb-2 text-gray-800`}>Create a Vidio Account</Text>
          ...
          {/* Forgot Password */}
          <TouchableOpacity>
            <Text style={tw`text-red-500 text-right font-semibold mb-4`}>Forgot Password?</Text>
          </TouchableOpacity>

          {/* Tombol Sign In dengan ButtonPrimary */}
          <ButtonPrimary title="   Sign in   " bgBtn="[#ED203F]" bgText="neutral-200" rute="home" />

          {/* Social Login Section */}
          <View style={tw`w-full items-center mt-2 mb-4`}>
          ...
          <View style={tw`flex-row mt-4`}>
            ...
            <TouchableOpacity>
              <Text style={tw`text-blue-500 text-sm font-medium`}>Sign Up</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={tw`flex-row mt-1`}>
            <TouchableOpacity>
              <Text style={tw`text-blue-500 text-sm`}>Terms of Service</Text>
            </TouchableOpacity>
            <Text style={tw`text-neutral-600 text-sm`}> and </Text>
            <TouchableOpacity>
              <Text style={tw`text-blue-500 text-sm`}>Privacy Policy</Text>
            </TouchableOpacity>
          </View>
        </View>
      </KeyboardAvoidingView>
